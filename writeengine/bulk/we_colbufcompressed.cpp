...
int ColumnBufferCompressed::saveCompressionHeaders( )
{
    ...
    auto lbid = compress::CompressInterface::getLBID0(hdrBuf);
    ...
    if (lbid)
    {
        compress::CompressInterface::setLBID0(hdrBuf, lbid);
        compress::CompressInterface::setLBID1(hdrBuf,
                                              fColInfo->getLastUpdatedLBID());
    }
    else
    {
        compress::CompressInterface::setLBID0(hdrBuf,
                                              fColInfo->getLastUpdatedLBID());
    }
