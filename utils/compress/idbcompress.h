...
public:
    ...
    */
     ...
     * getLBID
     */
    EXPORT static uint64_t getLBID0(const void* hdrBuf);

    /**
     * setBID
     */
    EXPORT static void setLBID0(void* hdrBuf, uint64_t lbid);

    /**
     * getLBID
     */
    EXPORT static uint64_t getLBID1(const void* hdrBuf);

    /**
     * setBID
     */
    EXPORT static void setLBID1(void* hdrBuf, uint64_t lbid);
 ...
 *  interfaces.
 */
EXPORT void initializeCompressorPool(
 ...
 */
EXPORT std::shared_ptr<CompressInterface> getCompressorByType(
    std::unordered_map<uint32_t, std::shared_ptr<CompressInterface>>&
        compressorPool,
