...
// FIXME: undef before pull reques
...
// Get start LBID
//------------------------------------------------------------------------------
uint64_t CompressInterface::getLBID0(const void* hdrBuf)
{
...
// Set start LBID
//------------------------------------------------------------------------------
void CompressInterface::setLBID0(void* hdrBuf, uint64_t lbid)
{
    if (lbid)
...
// Get start LBID
//------------------------------------------------------------------------------
uint64_t CompressInterface::getLBID1(const void* hdrBuf)
{
...
// Set start LBID
//------------------------------------------------------------------------------
void CompressInterface::setLBID1(void* hdrBuf, uint64_t lbid)
{
    if (lbid)
