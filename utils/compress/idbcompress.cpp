...
//------------------------------------------------------------------------------
int CompressInterface::verifyHdr(const void* hdrBuf) const
{
...
//------------------------------------------------------------------------------
int CompressInterface::getPtrList(const char* ptrBuf,
...
//------------------------------------------------------------------------------
int CompressInterface::getPtrList(const char* hdrBuf, CompChunkPtrList& chunkPtrs ) const
{
...
//------------------------------------------------------------------------------
unsigned int CompressInterface::getPtrCount(const char* hdrBuf) const
{
...
// Wrapper of above method for backward compatibility
//------------------------------------------------------------------------------
void CompressInterface::storePtrs(const std::vector<uint64_t>& ptrs, void* ptrBuf) const
{
...
//------------------------------------------------------------------------------
void CompressInterface::initHdr(void* hdrBuf, int compressionType) const
{
...
//------------------------------------------------------------------------------
void CompressInterface::initHdr(void* hdrBuf, void* ptrBuf, int compressionType, int hdrSize) const
{
...
//------------------------------------------------------------------------------
void CompressInterface::setBlockCount(void* hdrBuf, uint64_t count) const
{
...
//------------------------------------------------------------------------------
uint64_t CompressInterface::getBlockCount(const void* hdrBuf) const
{
...
//------------------------------------------------------------------------------
void CompressInterface::setHdrSize(void* hdrBuf, uint64_t size) const
{
...
//------------------------------------------------------------------------------
uint64_t CompressInterface::getHdrSize(const void* hdrBuf) const
{
...
int32_t CompressInterfaceSnappy::uncompress(const char* in, size_t inLen,
                                            char* out, size_t* outLen) const
{
    if (snappy::GetUncompressedLength(in, inLen, outLen) &&
